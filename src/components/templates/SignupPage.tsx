  ...
  return (
    <div className="flex flex-col justify-center items-center h-[90vh]">
      ...
      >
        ...
        <input
          {...register("password", {
            ...
            pattern: {
              ...
              message: "حداقل ۸ کارکتر، ۱حرف بزرگ و عدد",
            },
          })}
          type="password"
          className={` ${
        ...
        <label className="text-meBlue mb-3 font-normal">تکرار رمز عبور</label>
        <input
          {...register("rePassword", {
            required: "تکرار رمز عبور خود را وارد کنید",
            validate: {
              isCorrect: (fieldValue) => {
                const passValue = watch("password");
                return fieldValue === passValue || "تکرار رمز عبور نادرست است";
              },
            },
          })}
          type="password"
          className={` ${
            errors.rePassword ? "mb-1" : "mb-10"
          } w-64 border border-meBlue border-dashed text-gray-500 rounded-md p-3 text-left text-base h-10 focus:border-solid`}
        />
        {errors.rePassword && (
          <span className=" text-red-600 mb-3 text-sm">
